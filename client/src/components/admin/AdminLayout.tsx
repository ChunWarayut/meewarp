...
const navItems: NavItem[] = [
  ...
  { label: '💰 บัญชีสรุปร้าน', to: '/admin/store-accounting' },
  { label: '📊 สรุปรายสัปดาห์', to: '/admin/weekly-settlement' },
  { label: '⚙️ ตั้งค่าบัญชี', to: '/admin/store-accounting-settings', roles: ['superadmin'] },
